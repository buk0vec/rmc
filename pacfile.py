...
import codec_old    # module where the actual PAC coding functions reside(this module only specifies the PAC file format)
...
class PACFile(AudioFile):
    ...
    def Encode(self,data,codingParams):
        ...
        return codec_old.Encode(data,codingParams)
    ...
    def Decode(self,scaleFactor,bitAlloc,mantissa, overallScaleFactor,codingParams):
        ...
        return codec_old.Decode(scaleFactor,bitAlloc,mantissa, overallScaleFactor,codingParams)
